...
cd librevenge-${RVNG_VERSION} && ./configure --disable-tests && make && make install DESTDIR=$OUT && cd -
...
cd libvisio-${VISIO_VERSION} && ./configure --disable-tests --disable-tools && make && make install DESTDIR=$OUT && cd -
